...
{
	//std::cout << " start Sent int debug" << std::endl;
	//std::cout << ID << std::endl;
	//std::cout << "end Sent int debug" << std::endl;
...
{
	//std::cout << " start Sent packet debug" << std::endl;
	//std::cout << _packettype << std::endl;
	//std::cout << "end Sent packet debug" << std::endl;
...
{
	//std::cout << " start Sent string debug" << std::endl;
	//std::cout << _string << std::endl;
	//std::cout << "end Sent string debug" << std::endl;
...
bool Server::SendEntity(int ID, std::string& _string)
{
	//std::cout << " start Sent entity debug" << std::endl;
	//std::cout << _string << std::endl;
	//std::cout << "end Sent entity debug" << std::endl;
	if (!SendPacketType(ID, P_CircleData)) //Send packet type: Chat Message, If sending packet type fails...
		return false; //Return false: Failed to send string
	int bufferlength = _string.size(); //Find string buffer length
	if (!SendInt(ID, bufferlength)) //Send length of string buffer, If sending buffer length fails...
...
bool Server::GetEntity(int ID, std::string& _string)
{
	not_digit notADigit;
	int bufferlength; //Holds length of the message
	if (!GetInt(ID, bufferlength)) //Get length of buffer and store it in variable: bufferlength
	...
	//std::string::iterator end = std::remove_if(_string.begin(), _string.end());
